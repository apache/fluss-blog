...
date: 2025-06-18
tags: [announcement]
description: "Fluss 0.7 advances production readiness with stability improvements, a new tiering architecture, stronger security, and Java client support."
image: ./../assets/0.7/banner-1200x510.webp
---
...
See more details in the [Streaming Lakehouse documentation](/docs/0.7/maintenance/tiered-storage/lakehouse-storage/).
...
For details, please refer to the [Security documentation](/docs/0.7/security/overview/) and quickstarts.
...
For usage examples and configuration parameters, see the [DataStream Connector documentation](/docs/0.7/engine-flink/datastream/).
