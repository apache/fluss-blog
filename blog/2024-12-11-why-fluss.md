...
authors: [jark]
tags: [engineering]
description: "Explore four challenges of using Kafka for real-time analytics, and why analytical workloads need a different approach to streaming storage."
image: ./assets/why_fluss/banner-1200x510.webp
---
